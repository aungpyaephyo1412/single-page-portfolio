            ...
            <div className='min-h-screen container mx-auto flex justify-center items-center'>
                <div className='w-full flex gap-3 p-5 flex-wrap'>
                    ...
                    <motion.div
                        ...
                        className='w-full  md:w-3/4 md:mx-auto lg:w-[32%] bg-secondary p-5 rounded-lg shadow-lg'>
                    ...
                    <div   className='w-full flex justify-center items-center flex-wrap mt-5'>
                        ...
                        <div className='flex items-center flex-wrap gap-3'>
                            <motion.img
                                ...
                                src={Github} className='w-[50px] h-[50px] object-contain' alt="logo"/>
                            <motion.img
                                initial={{ opacity: 0}}
                                    transition={{ duration: 0.5,delay:0.2,velocity:easeIn }}
                                    whileInView={{ opacity: 1  }}
                                src={HTMl} className='w-[50px] h-[50px] object-contain' alt="logo"/>
                            <motion.img
                                initial={{ opacity: 0}}
                                    transition={{ duration: 0.5,delay:0.2,velocity:easeIn }}
                                    whileInView={{ opacity: 1  }}
                                src={CSS} className='w-[50px] h-[50px] object-contain' alt="logo"/>
                            <motion.img
                                initial={{ opacity: 0}}
                                    transition={{ duration: 0.5,delay:0.2,velocity:easeIn }}
                                    whileInView={{ opacity: 1  }}
                                src={JS} className='w-[50px] h-[50px] object-contain' alt="logo"/>
                            <motion.img
                                initial={{ opacity: 0}}
                                    transition={{ duration: 0.5,delay:0.2,velocity:easeIn }}
                                    whileInView={{ opacity: 1  }}
                                src={BT} className='w-[50px] h-[45px] object-contain' alt="logo"/>
                            <motion.img
                                initial={{ opacity: 0}}
                                    transition={{ duration: 0.5,delay:0.2,velocity:easeIn }}
                                    whileInView={{ opacity: 1  }}
                                src={TAW} className='w-[50px] h-[50px] object-contain' alt="logo"/>
                            <motion.img
                                initial={{ opacity: 0}}
                                    transition={{ duration: 0.5,delay:0.2,velocity:easeIn }}
                                    whileInView={{ opacity: 1  }}
                                src={REACT} className='w-[50px] h-[50px] object-contain' alt="logo"/>
                            <motion.img
                                initial={{ opacity: 0}}
                                    transition={{ duration: 0.5,delay:0.2,velocity:easeIn }}
                                    whileInView={{ opacity: 1  }}
                                src={REDUX} className='w-[50px] h-[50px] object-contain' alt="logo"/>
                            <motion.img
                                initial={{ opacity: 0}}
                                    transition={{ duration: 0.5,delay:0.2,velocity:easeIn }}
                                    whileInView={{ opacity: 1  }}
                                src={Git} className='w-[50px] h-[50px] object-contain' alt="logo"/>
                            <motion.img
                                initial={{ opacity: 0}}
                                    transition={{ duration: 0.5,delay:0.2,velocity:easeIn }}
                                    whileInView={{ opacity: 1  }}
                                src={Figma} className='w-[50px] h-[50px] object-contain' alt="logo"/>
