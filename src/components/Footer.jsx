...
const Footer = () => {
    return(
        ...
        <footer
            className=" mt-5 w-full p-4 bg-footer border-t border-gray-200 shadow md:flex md:items-center md:justify-between md:p-6 dark:bg-gray-800 dark:border-gray-600 gap-y-4">
